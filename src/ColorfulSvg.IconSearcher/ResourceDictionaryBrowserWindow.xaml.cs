...
public partial class ResourceDictionaryBrowserWindow : Window
{
    ...
    public ResourceDictionaryBrowserWindow()
    {
        InitializeComponent();
    ...
    private void LoadResourceFile(string filePath)
    {
        ...
        catch (Exception ex)
        {
            ...
            MessageBox.Show(this, ex.Message, "读取资源文件失败", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
